...
const EditPartner = () => {
  ...
  const handleImageUpload = (event) => {
    ...
    const handleSavePartner = async (e) => {
      ...
      try {
        ...
        await axios.patch(`${BASEURL}/partner/update/${partnerData?.data?._id}`, formData, {
          headers: {
  ...
  return (
    <div className="p-5 rounded-md shadow-md bg-white">
     ...
     <div className="flex">
     <div className="w-1/3">
        <form  onSubmit={handleSavePartner}  className="flex flex-col gap-5 py-3">
          {/*========== Product Basic=========== */}
         ...
         <div className="flex items-center justify-between">
            ...
            <input
              ...
              defaultValue={partnerData?.data?.name_en}
            ...
            <input
              ...
              defaultValue={partnerData?.data?.name_cn}
              className="font-semibold text-black text-sm bg-[#F8F8F8] p-2 px-3 rounded-sm "
            />
          </div>
